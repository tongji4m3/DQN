...
tf.flags.DEFINE_string('logdir', '', 'Directory of logfile.')
...
def make_agent(agent_type, env, num_kmeans, use_extra_travel_penalty, use_extra_bit,
    ...
    if agent_type == 'dqn':
        ...
        meta_controller_state_fn, check_subgoal_fn, num_subgoals, subgoals = kmeans.get_cluster(
            n_kmeans=num_kmeans, extra_bit=use_extra_bit)
...
def run(env_name='MountainCar-v0',
    ...
    agent = make_agent(agent_type, env, 10, True, True, True, True, True, 100, False)
    # def make_agent(agent_type, env, num_kmeans, use_extra_travel_penalty, use_extra_bit,
    #                use_controller_dqn, use_intrinsic_timeout, use_memory, memory_size, pretrain_controller):
    print ('Made agent!')
